...
func int Tpl_1430_Templer_CALLSLEEPER_Condition()
{
	...
	if((CorKalom_BringBook == LOG_SUCCESS) && (Npc_GetDistToWP(Templer,"PSI_TEMPLE_STAIRS_3") < 1000) && C_TimeForGreatPrayer() && !Npc_KnowsInfo(hero,NOV_1319_Novize_CALLSLEEPER) && !Npc_KnowsInfo(hero,NOV_1320_Novize_CALLSLEEPER) && !Npc_KnowsInfo(hero,Tpl_1431_Templer_CALLSLEEPER) && (Npc_GetDistToWP(Kalom,"PSI_TEMPLE_STAIRS_RIGHT") < 300))
	{
		return TRUE;
	};
};
